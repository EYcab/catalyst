...
from catalyst.rl.registry import ALGORITMS, ENVIRONMENTS
...
def main(args, unknown_args):
    ...
    algorithm = ALGORITMS.get(args.algorithm)
    if args.environment is not None:
        # @TODO: remove this hack
        # come on, just refactor whole rl
        environment_fn = ENVIRONMENTS.get("environment", args.environment)
